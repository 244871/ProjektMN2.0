...
public class Secant extends RootFinder implements IRootFinder {
    @Override
    ...
    private double calculate(IEquation equation){
        ...
        {
            // Find middle point
            c = (equation.calculateEquation(a)*(c-a))/(equation.calculateEquation(c)-equation.calculateEquation(a));
